...
Такая покупа даёт возможность добавить одну рекомендацию — выполняет именно то, как называется. Покупка одноразовая, после использования возможность рекомендации исчезает. Обратите внимание, если вы после покупки добавите рекомендацию, а потом удалите её, то возможности добавить новую реферальную ссылку не будет.
